...
import {
  CurriculumGateway,
  CurriculumHelp,
} from "@/components/curriculum-context"
...
export function CurriculumOverview({
  ...
  return (
    <div className="course-overview--focused">
      <CurriculumSearch entries={entries}>
        <section className="course-hero" aria-labelledby="course-title">
          <div className="course-hero__copy">
            ...
            <p className="course-hero__lede">
              {tr(
                "Understand what you trust. Learn to control your Linux computer, start clean and verify Core. Practice a simple wallet and recovery with test coins. Add complexity only when it solves a real problem.",
          ...
          >
            ...
            {hasRetainedProgress && (
              <p className="course-local-note">
                Your earlier work is retained. Continue to the new Linux, trust
                and practical checks. Earlier confirmations remain saved; new
                skills need their own results.
              </p>
            )}
            {returning && (
                            ...
                            <details className="course-milestone">
                              ...
                              <ol>
                                {phase.lessons
                                  .filter(
                                    (lesson) =>
                                      lesson.chapter === milestone.title
                                  )
                                  .map((lesson) => (
                                    <li key={lesson.id}>
                                      <button
                        ...
                        <li key={chapter}>
                          <details className="course-milestone course-milestone--optional">
                            <summary>
                              <span>{chapter}</span>
                              <small>
                                Optional · outside the required path
                              </small>
                            </summary>
                            <ol>
                              {phase.lessons
