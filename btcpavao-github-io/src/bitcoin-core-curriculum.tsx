...
const CHECKLIST_STORAGE_KEY = "btcpavao-core-curriculum-checklists-v2"
  ...
  return (
    <nav className="course-outline" aria-label="Faze i lekcije kurikuluma">
      ...
      <div className="course-outline__progress">
        <span>
          Tvoj napredak
          <small>{availableCount} koraka na glavnom putu</small>
        </span>
      ...
      >
        {allPhases ? "Prikaži trenutnu fazu" : "Prikaži sve faze"}
      </button>
      <button
        type="button"
        className="course-outline__toggle"
      ...
      >
        {showOptional ? "Sakrij izborno čitanje" : "Prikaži izborno čitanje"}
      </button>
            ...
            <div className="course-player__main">
              ...
              {nextEntry && !isAvailableLesson(nextEntry.lesson) ? (
                <aside className="course-next-notice">
                  ...
                  <div>
                    <strong>Sljedeća obavezna vježba još čeka provjeru.</strong>
                    <p>
                      Vođeni put ovdje staje. Možeš pročitati nacrt, ali time ne
                      potvrđuješ izvedenu vježbu.
                    </p>
                    <button
                      type="button"
                    ...
                    >
                      Pročitaj nacrt: {nextEntry.lesson.title}
                    </button>
                  </div>
                </aside>
              ) : null}
              ...
              >
                ...
                completedLessons.has(activeLesson.id) ? (
                  ...
                  >
                    <span>
                      <small>Nastavi glavnim putem</small>
